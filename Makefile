...
build/anime.exe: build/anime.a build/main.o 
	clang -ffreestanding -rtlib=none -o build/anime.exe build/main.o build/anime.a /usr/lib/libc.a /usr/lib/crt0.o    2>&1
