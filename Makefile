...
build/anime_lexer_module.i: build/anime_lexer_module.c build/lib__00__oldies.ci build/lib__01__pre_header.ci build/lib__02__header.ci build/lib__03.ci build/lib__04__string_stack.ci build/lib__05__error_state.ci build/lib__06__exception.ci build/lib__07__buffered_outstream.ci build/lib__08__cstring.ci build/lib__09__write_string.ci build/lib__10__local_alloca.ci build/lib__11__buffer_to_fd.ci build/anime_global.h build/anime.h build/anime_type.h build/anime_lexer_module.h build/anime_lexer_module_token_type.ci build/anime_lexer_module_automata.ci build/anime_lexer_module_print.ci 
...
build/anime_generation_module.o: build/anime_generation_module.c build/lib__00__oldies.ci build/lib__01__pre_header.ci build/lib__02__header.ci build/lib__03.ci build/lib__04__string_stack.ci build/lib__05__error_state.ci build/lib__06__exception.ci build/lib__07__buffered_outstream.ci build/lib__08__cstring.ci build/lib__09__write_string.ci build/lib__10__local_alloca.ci build/lib__11__buffer_to_fd.ci build/anime_global.h build/anime.h build/anime_type.h build/anime_generation_module.h build/anime_lexer_module.h build/anime_generation_module_infix_to_postfix.ci 
	clang -std=c99 -D_THREAD_SAFE -D_REENTRANT -D __DEBUG__ -D DEBUG -O0  -D ENDIANNESS=little -D PIPEBUFFERSIZE=65534 -D STDLIB_PROVIDES_ARC4RANDOM  -fmessage-length=0 -fdiagnostics-show-location=once -fdiagnostics-show-option -fstack-check  -fverbose-asm -ffreestanding -feliminate-unused-debug-types  -Wall -W -Wextra  -Werror -Wfatal-errors  -Werror-implicit-function-declaration -Wparentheses -Wimplicit -Wreturn-type -Wcomment -Wpointer-arith -Wchar-subscripts -Wimplicit-int -Werror-implicit-function-declaration -Wmain -Wmissing-braces -Wmultichar -Wsequence-point -Wreturn-type -Wstrict-prototypes -Wpacked -Wcast-qual -Winline -Wformat-nonliteral -Wwrite-strings -Wmissing-field-initializers -Wsign-compare  -Wformat-zero-length -Wswitch -Wswitch-enum -Wswitch-default -Wnested-externs -Wunknown-pragmas  -gfull -W -Wextra -Wnewline-eof -Wno-unsequenced         -fno-exceptions -fno-omit-frame-pointer  -fno-builtin -fno-builtin-printf -fno-builtin-abs -fno-builtin-strcpy -fno-builtin-strcat -fno-builtin-strlen -fno-builtin-bzero -fno-builtin-memset -fno-builtin-memcpy -fno-builtin-assert -fno-builtin-tolower -fno-builtin-toupper -fno-builtin-log -fno-builtin-alloca -fno-common -fno-exceptions -fno-non-call-exceptions -fno-asynchronous-unwind-tables -fno-inline -fno-inline-functions -fno-inline-functions  -Wno-cast-align -Wno-system-headers  -Wno-undef -Wno-redundant-decls -Wno-unused -Wno-unused-parameter -Wno-unused-function -Wno-switch-default -Wno-format-nonliteral    -c build/anime_generation_module.c -o build/anime_generation_module.o  2>&1
