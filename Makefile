...
build_hi: build build/anime_lexer_module_automata.hi build/anime_lexer_module_token_type.hi build/anime_module_type.hi build/main_inc.hi 
...
build/main.i: build/main.c build/lib__00__oldies.ci build/lib__01__pre_header.ci build/lib__02__header.ci build/lib__03.ci build/lib__04__string_stack.ci build/lib__05__error_state.ci build/lib__06__exception.ci build/lib__07__buffered_outstream.ci build/lib__08__cstring.ci build/lib__09__write_string.ci build/lib__10__local_alloca.ci build/lib__11__buffer_to_fd.ci build/main_inc.hi build/main.h build/anime.h build/main_stdlog_buffering.ci build/main_subr.ci build/main_options.ci 
